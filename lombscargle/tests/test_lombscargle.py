...
from .. import lombscargle_slow, lombscargle_scipy
...
@pytest.mark.parametrize('normalization', ['normalized'])
def test_lombscargle_methods_common(lombscargle_method, center_data,
    ...
    expected_output = lombscargle_slow(t, y, freq, fit_bias=False, **kwds)
